...
public class histo_training_normal extends AppCompatActivity {
    ...
    String TAG = "histo_training_normal";
    String file_name;
    FileWriter writer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.histo_training_normal);
        ...
        if (orientation == Configuration.ORIENTATION_LANDSCAPE) {
            // In landscape
            mv.setImageResource(R.drawable.histo_training);
        } else {
            // In portrait
            mv.setImageResource(R.drawable.histo_training);
        }
        ...
        sfg.setOnFingerGestureListener(new SimpleFingerGestures_Mod.OnFingerGestureListener() {
            ...
            public boolean onSwipeUp(int fingers, long gestureDuration, double gestureDistance) {
                if (fingers == 1) {
                    ...
                    Intent back_to_graph_selector = new Intent(histo_training_normal.this, GraphSelector.class);
                    startActivity(back_to_graph_selector);

                }
                else if (fingers == 5) {
                    // Write your code here for swiping UP with 5 fingers
                }
                return false;
            }
    ...
    public void logger(String file_name) throws IOException {
        ...
        final Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                if (ContextCompat.checkSelfPermission(histo_training_normal.this,Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(histo_training_normal.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},1);
                }
                else {
